...
- Artificial Intelligence tools were used during this project to help explain certain algorithmic concepts, such as the implementation of sorting strategies (e.g. Longest Increasing Subsequence – LIS) but NOT USED, and to suggest possible optimizations that could be applied to improve the solution.

    AI was also used to assist in generating parts of this README.md, including text formulation, structure, and Markdown formatting.

    The design, implementation, and coding of the push_swap algorithm itself were done manually, without the use of AI-generated code.